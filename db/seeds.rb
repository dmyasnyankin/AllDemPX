...
photo16 = Photo.create(title:"lama", author_id: demo1.id)
photo17 = Photo.create(title:"india", author_id: demo2.id)
photo18 = Photo.create(title:"nyc1", author_id: demo3.id)
photo19 = Photo.create(title:"nyc2", author_id: demo1.id)
photo20 = Photo.create(title:"chicago2", author_id: demo2.id)
photo21 = Photo.create(title:"brooklyn1", author_id: demo3.id)
photo22 = Photo.create(title:"mastiff", author_id: demo1.id)
photo23 = Photo.create(title:"brooklyn2", author_id: demo2.id)
